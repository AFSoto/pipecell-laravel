        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="https://wa.me/57XXXXXXXXXX" target="_blank" class="w-9 h-9 bg-slate-800 hover:bg-green-600 rounded-xl flex items-center justify-center transition">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-slate-400 text-sm">+57 XXX XXX XXXX</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-4 h-4 text-blue-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-slate-400 text-sm">Tu dirección aquí, Ciudad</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-4 h-4 text-blue-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
